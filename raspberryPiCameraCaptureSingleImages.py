...
This is intended to be used with the Raspberry Pi camera.
The software is being testing firest on a Raspberry Pi Zero
but 'should' run on either a RaspberryPi 2/3/4 using the
Raspberry Pi camera using the camera port.
